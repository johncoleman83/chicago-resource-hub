(function (window, undefined) {
  var FuzeGoogleMapsLib = function (options) {
    var self = this;
  ...
  FuzeGoogleMapsLib.prototype.submitSearch = function (whereClause, map) {
      var self = this;
  ...
  FuzeGoogleMapsLib.prototype.getgeoCondition = function (address, callback) {
      var self = this;
      if (address !== "") {
  ...
  FuzeGoogleMapsLib.prototype.doSearch = function () {
      var self = this;
      self.clearSearch();
  ...
  FuzeGoogleMapsLib.prototype.reset = function () {
  ...
  FuzeGoogleMapsLib.prototype.getInfo = function (callback) {
      var self = this;
      jQuery.ajax({
  ...
  FuzeGoogleMapsLib.prototype.addrFromLatLng = function (latLngPoint) {
      var self = this;
      self.geocoder.geocode({
          'latLng': latLngPoint
      }, function (results, status) {
  ...
  FuzeGoogleMapsLib.prototype.drawSearchRadiusCircle = function (point) {
      var self = this;
      var circleOptions = {
          strokeColor: "#4b58a6",
          strokeOpacity: 0.3,
  ...
  FuzeGoogleMapsLib.prototype.query = function (query_opts, callback) {
      var queryStr = [],
          self = this;
  ...
  FuzeGoogleMapsLib.prototype.handleError = function (json) {
  ...
  FuzeGoogleMapsLib.prototype.getCount = function (whereClause) {
      var self = this;
  ...
  FuzeGoogleMapsLib.prototype.displaySearchCount = function (json) {
      var self = this;
...
FuzeGoogleMapsLib.prototype.getList = function(whereClause) {
      var self = this;
  ...
  FuzeGoogleMapsLib.prototype.displayList = function(json) {
      var self = this;
  ...
  FuzeGoogleMapsLib.prototype.addCommas = function (nStr) {
      nStr += '';
      x = nStr.split('.');
      x1 = x[0];
      x2 = x.length > 1 ? '.' + x[1] : '';
  ...
  // maintains map centerpoint for responsive design
  FuzeGoogleMapsLib.prototype.calculateCenter = function () {
      var self = this;
      center = self.map.getCenter();
  };

  //converts a slug or query string in to readable text
  FuzeGoogleMapsLib.prototype.convertToPlainString = function (text) {
      if (text === undefined) return '';
      return decodeURIComponent(text);
  };

  FuzeGoogleMapsLib.prototype.clearSearch = function () {
      var self = this;
