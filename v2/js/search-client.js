(function (window, undefined) {
  var CRHSearch = function (options) {
    var self = this;
  ...
  CRHSearch.prototype.submitSearch = function (whereClause, map) {
      var self = this;
  ...
  CRHSearch.prototype.getgeoCondition = function (address, callback) {
      var self = this;
      if (address !== "") {
  ...
  CRHSearch.prototype.doSearch = function () {
      var self = this;
      self.clearSearch();
  ...
  CRHSearch.prototype.reset = function () {
  ...
  CRHSearch.prototype.getInfo = function (callback) {
      var self = this;
      jQuery.ajax({
  ...
  CRHSearch.prototype.addrFromLatLng = function (latLngPoint) {
      var self = this;
      self.geocoder.geocode({
          'latLng': latLngPoint
      }, function (results, status) {
  ...
  CRHSearch.prototype.drawSearchRadiusCircle = function (point) {
      var self = this;
      var circleOptions = {
          strokeColor: "#4b58a6",
          strokeOpacity: 0.3,
  ...
  CRHSearch.prototype.query = function (query_opts, callback) {
      var queryStr = [],
          self = this;
  ...
  CRHSearch.prototype.handleError = function (json) {
  ...
  CRHSearch.prototype.getCount = function (whereClause) {
      var self = this;
  ...
  CRHSearch.prototype.displaySearchCount = function (json) {
      var self = this;
...
CRHSearch.prototype.getList = function(whereClause) {
      var self = this;
  ...
  CRHSearch.prototype.displayList = function(json) {
      var self = this;
  ...
  CRHSearch.prototype.addCommas = function (nStr) {
      nStr += '';
      x = nStr.split('.');
      x1 = x[0];
      x2 = x.length > 1 ? '.' + x[1] : '';
  ...
  // maintains map centerpoint for responsive design
  CRHSearch.prototype.calculateCenter = function () {
      var self = this;
      center = self.map.getCenter();
  };

  //converts a slug or query string in to readable text
  CRHSearch.prototype.convertToPlainString = function (text) {
      if (text === undefined) return '';
      return decodeURIComponent(text);
  };

  CRHSearch.prototype.clearSearch = function () {
      var self = this;
